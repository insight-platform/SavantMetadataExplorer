...
/**
 * This directive is intended to be used in conjunction with savant-lib-popover tag. It is
 * responsible for toggling the display of the provided popover instance.
 */
@Directive({
  selector: '[savantLibPopoverTrigger]',
  exportAs: 'savantPopoverTrigger',
})
export class PopoverTriggerDirective implements AfterViewInit, OnChanges, OnDestroy {
  /** References the popover instance that the trigger is associated with. */
  @Input('savantLibPopoverTrigger') popover: IPopoverPanel;
